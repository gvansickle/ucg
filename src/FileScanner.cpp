...
const char * FileScanner::find_first_of_sse4_2(const char * __restrict__ cbegin, size_t len) noexcept
{
	__m128i looking_for = _mm_set1_epi8(m_compiled_cu_bitmap[0]);
