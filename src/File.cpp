...
const char* File::GetFileData(int file_descriptor, size_t file_size, size_t preferred_block_size)
{
	...
	else
	{
		...
		//   @note POSIX_FADV_WILLNEED doesn't affect timed performance much, but destroys user-mode concurrency as measured
		//         with VTune.  Assume file-reading work is simply being moved into kernel.
