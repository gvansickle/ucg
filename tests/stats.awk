...
$1 ~ /^NUM_MATCHED_LINES:/ { NUM_MATCHED_LINES=$2; }
$1 ~ /^NUM_CHARS_DIFF:/ { NUM_DIFF_CHARS=$2; }
$1 ~ /^real/ {
...
END {
	...
	print("| " TEST_PROG_ID, AVG_TIME, SAMPLE_STD_DEV, SEM, NUM_MATCHED_LINES, NUM_DIFF_CHARS " |");
}
